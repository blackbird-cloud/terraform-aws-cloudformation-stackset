...
| <a name="input_stackset_instance_organizational_unit_ids"></a> [stackset\_instance\_organizational\_unit\_ids](#input\_stackset\_instance\_organizational\_unit\_ids) | The organization root ID or organizational unit (OU) IDs to which StackSets instance deploys. | `list(string)` | `[]` | no |
